...
const photos = [
  { id: 1, src: 'public/memory1.jpeg', x: -15, y: -25, rot: -5 },
  { id: 2, src: 'public/memory2.jpeg', x: 15, y: -15, rot: 8 },
  { id: 3, src: 'public/memory3.jpeg', x: -10, y: 20, rot: -12 },
  { id: 4, src: 'public/memory4.jpeg', x: 15, y: 25, rot: 5 },
];
    ...
    <div ref={containerRef} className="relative w-full max-w-6xl h-[70vh] md:h-[80vh] border-[12px] border-black bg-cream overflow-hidden shadow-[32px_32px_0px_0px_rgba(0,0,0,0.05)] rounded-tl-[5rem] rounded-br-[5rem] rounded-tr-3xl rounded-bl-3xl group">
       ...
       {photos.map((p, i) => (
         <motion.div
           ...
           style={{ left: `calc(50% + ${p.x}%)`, top: `calc(50% + ${p.y}%)`, rotate: p.rot, x: '-50%', y: '-50%' }}
         ...
         >
           <div className="relative overflow-hidden rounded-lg">
             ...
             <img src={p.src} alt="Evidence" className="w-28 h-28 sm:w-40 sm:h-40 md:w-64 md:h-64 object-cover pointer-events-none grayscale group-hover/photo:grayscale-0 transition-all duration-700" />
           </div>
